...
public interface IBaseFragment extends IBaseView {
     ...
     */
    void startNewFragment(@NonNull Fragment supportFragment);
     ...
     * @param supportFragment 要跳往的Fragment(继承自supportFragment)
     */
    void startNewFragmentWithPop(@NonNull Fragment supportFragment);
     ...
     */
    void startNewFragmentForResult(@NonNull Fragment supportFragment, int requestCode);
