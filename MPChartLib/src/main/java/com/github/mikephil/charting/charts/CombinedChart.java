...
import static com.github.mikephil.charting.listener.ChartTouchListener.DRAG;
import static com.github.mikephil.charting.listener.ChartTouchListener.HIGH_TLIGHT;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_MOVE:
                if( mChartTouchListener.getTouchMode() == DRAG
                        || mChartTouchListener.getTouchMode() == HIGH_TLIGHT){
